...
export default function Home() {
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors">
        ...
        <div className="mx-auto max-w-6xl px-6 py-16 md:py-20">
          <div className="grid gap-12 md:grid-cols-2 md:items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute bottom-6 right-0 md:right-4 bg-white dark:bg-gray-700 rounded-xl shadow-lg px-4 py-3 flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-teal flex items-center justify-center text-white">
                  <LocationIcon />
                </div>
                <div>
                  <p className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide">Lokalizacja</p>
                  <p className="font-medium text-gray-900 dark:text-white">Bydgoszcz & Online</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Quote Section */}
      <section className="py-16 md:py-20 dark:bg-gray-900">
        <div className="mx-auto max-w-3xl px-6 text-center">
          <div className="flex justify-center mb-6">
            <span className="text-coral text-5xl font-serif">&quot;</span>
          </div>
          <blockquote className="font-serif text-xl md:text-2xl italic text-gray-700 dark:text-gray-300 leading-relaxed">
            Nie jesteśmy odpowiedzialni za to, co nam się przydarza, ale jesteśmy odpowiedzialni za to, co z tym zrobimy.
          </blockquote>
          <p className="mt-6 text-sm font-medium text-gray-500 dark:text-gray-400 tracking-wide">
            — JEAN-PAUL SARTRE
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div className="flex gap-4 justify-center lg:justify-start">
              <div className="w-40 h-56 rounded-2xl bg-cream-dark dark:bg-gray-700 flex items-center justify-center text-gray-400 text-xs">
                Zdjęcie 1
              </div>
              <div className="w-40 h-56 rounded-2xl bg-cream-dark dark:bg-gray-700 flex items-center justify-center text-gray-400 text-xs mt-8">
                Zdjęcie 2
              </div>
            </div>
              ...
              <div className="mt-8 flex flex-wrap gap-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">Integracyjne i Holistyczne</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="oferta" className="py-16 md:py-20 bg-gray-50 dark:bg-gray-800">
        <div className="mx-auto max-w-6xl px-6">
      ...
      {/* Kontakt Section */}
      <section id="kontakt" className="bg-cream-dark dark:bg-gray-800 py-16 md:py-20">
        <div className="mx-auto max-w-6xl px-6">
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <div className="bg-white dark:bg-gray-700 rounded-2xl p-8">
              ...
              <div className="mt-8 space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mt-1">ul. Gdańska 10/4</p>
                    <p className="text-gray-600 dark:text-gray-300">85-006 Bydgoszcz</p>
                  </div>
                </div>
              ...
              <div className="mt-8">
                <p className="text-gray-500 dark:text-gray-400 text-sm mb-3">Znajdź mnie w social mediach</p>
                <div className="flex gap-3">
                  <a href="#" className="w-10 h-10 rounded-full bg-gray-100 dark:bg-gray-600 flex items-center justify-center text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-500 transition-colors">
            ...
            <div className="space-y-6">
              ...
              {/* Map Placeholder - Teal background */}
              <div className="relative h-64 rounded-2xl overflow-hidden bg-teal">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    <p className="font-serif text-2xl text-white/40 italic">Mapa</p>
                    <p className="font-serif text-3xl text-white/30 italic">Bydgoszczy</p>
                  </div>
                </div>
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                  <div className="bg-white text-teal px-3 py-1.5 rounded-lg text-sm flex items-center gap-1.5 shadow-lg">
                    <LocationIcon />
